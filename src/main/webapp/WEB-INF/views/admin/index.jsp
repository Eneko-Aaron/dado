				...
				<tbody>
					<c:forEach items="${usuarios}" var="u">
						<tr>
							<td>${u.id}</td>
							<td>${u.nombre}</td>
							<td><c:if test="${u.fechaBaja == null}">Alta</c:if> <c:if
									test="${u.fechaBaja != null}">Baja</c:if></td>
							<td>
								<button type="button" class="btn btn-info" data-toggle="modal"
									data-target="#modalmodificar_${u.id}">Modificar</button>
								<button type="button" class="btn btn-danger" data-toggle="modal"
									data-target="#modaleliminar_${u.id}">Eliminar</button> <c:if
									test="${u.fechaBaja == null}">
									<button type="button" class="btn btn-warning"
										data-toggle="modal" data-target="#modalbaja_${u.id}">Dar
										de Baja</button>
								</c:if> <c:if test="${u.fechaBaja != null}">
									<button type="button" class="btn btn-success"
										data-toggle="modal" data-target="#modalalta_${u.id}">Dar
										de Alta</button>
								</c:if>
							</td>
						</tr>
		...
		<div id="modaleliminar_${u.id}" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>
							Seguro que desea <b>Eliminar</b> el usuario <b>${u.nombre}</b>
						</p>
					</div>
					<div class="modal-footer">
						<a href="admin/eliminar/${u.id}"><button type="button"
		...
		<div id="modalalta_${u.id}" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>
							Seguro que desea dar de <b>Alta</b> el usuario <b>${u.nombre}</b>
						</p>
					</div>
					<div class="modal-footer">
						<a href="admin/alta/${u.id}"><button type="button"
								class="btn btn-success">Dar de Alta</button></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="modalbaja_${u.id}" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>
							Seguro que desea dar de <b>Baja</b> el usuario <b>${u.nombre}</b>
						</p>
					</div>
					<div class="modal-footer">
						<a href="admin/baja/${u.id}"><button type="button"
								class="btn btn-warning">Dar de Baja</button></a>
					</div>
				</div>
			</div>
		</div>
